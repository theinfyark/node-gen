...
export function envFiles(config: ProjectConfig): GeneratedFile[] {
  ...
  if (auth === "jwt" || auth === "passport") {
    ...
    lines.push("AUTH_JWKS_URI=https://your-tenant.auth0.com/.well-known/jwks.json");
    ...
    lines.push("AUTH_JWKS_URI=https://your-org.okta.com/oauth2/default/v1/keys");
    lines.push("AUTH_ISSUER=https://your-org.okta.com/oauth2/default");
    lines.push("AUTH_AUDIENCE=api://default");
  } else if (auth === "keycloak") {
    lines.push("KEYCLOAK_REALM_URL=https://keycloak.example.com/realms/myrealm");
...
`
      : "";
  const typeExport = config.language === "ts" ? `\nexport type AppEnv = typeof appEnv;\n` : "";
